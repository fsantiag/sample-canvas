...
public class MainIntegrationTest {
    ...
    public void testMainRoutine() throws IOException {
        String canvasOutput =
                ...
                "Enter the command: \n" +
                "Error: Wrong number of arguments for command 'C'.\n" +
                "Enter the command: \n" +
                "Error: Wrong number of arguments for command 'L'.\n" +
                "Enter the command: \n" +
                "Error: Wrong number of arguments for command 'B'.\n" +
                "Enter the command: \n" +
                "Error: Wrong number of arguments for command 'R'.\n" +
                "Enter the command: \n" +
